...
const ErrorPage = () => {
  return (
    <div>
      ...
      <div className="pt-24 lg:pt-[10%] py-3 px-4 sm:px-8 lg:px-12">
        <div>
          <h3 className="text-xl sm:text-2xl font-semibold">404 Error page</h3>
        </div>
        ...
        <div className="flex justify-center pt-8 lg:pt-[5%]">
          <img
            src={iml}
            alt=""
            className="w-full max-w-[300px] sm:max-w-[420px]"
          />
        </div>

        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 text-center pt-6">
          <svg
            width="54"
            height="54"
            viewBox="0 0 54 54"
            ...
            className="w-10 h-10 sm:w-[54px] sm:h-[54px] shrink-0"
          >
            <path
        ...
        <div className="pt-10 lg:pt-[10%] max-w-5xl mx-auto text-center">
          <h1 className="text-base sm:text-xl lg:text-2xl font-medium leading-7 lg:leading-9">
          ...
          <Link
            to={"/"}
            className="grid place-items-center pt-8 lg:pt-[10%] w-full"
          >
            <CustomButtons text={"Go to Home Page"} button_width={"171px"} />
          </Link>
        </div>

        <div className="justify-center flex pt-8 lg:pt-[2%] text-center">
          <h2 className="text-base sm:text-xl lg:text-2xl font-medium pb-8 lg:pb-[5%] pt-4 lg:pt-[3%]">
